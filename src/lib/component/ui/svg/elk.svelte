...
<svg {width} height={width} viewBox="0 0 128 128" xmlns="http://www.w3.org/2000/svg">
	<path
		fill="#343741"
	...
	<path
		fill="#fec514"
		d="M111.695 30.648A61.485 61.485 0 0 0 117.922 24C106.188 9.379 88.199 0 68 0C42.715 0 20.957 14.71 10.574 36H98.04a20.123 20.123 0 0 0 13.652-5.352"
	/>
	<path
		fill="#00bfb3"
